import type { AgColumn, AgProvidedColumnGroup, ContainerType, IMenuFactory, NamedBean, ShowMenuAfterButtonClickOptions } from 'ag-grid-community';
...
export declare class EnterpriseMenuFactory extends BeanStub implements NamedBean, IMenuFactory {
    ...
    showMenuAfterButtonClick(columnOrGroup: AgColumn | AgProvidedColumnGroup | undefined, eventSource: HTMLElement, containerType: ContainerType, onClosedCallback?: (event?: Event) => void, options?: ShowMenuAfterButtonClickOptions): boolean;
    private showMenu;
