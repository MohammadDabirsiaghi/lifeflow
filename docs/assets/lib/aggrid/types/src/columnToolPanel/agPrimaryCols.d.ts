import type { ColDef, ColGroupDef, ColumnEventType, ColumnMenuItemsSource } from 'ag-grid-community';
...
export declare class AgPrimaryCols extends Component {
    ...
    constructor();
    init(allowDragging: boolean, params: ToolPanelColumnCompParams, eventType: ColumnEventType, source: ColumnMenuItemsSource): void;
