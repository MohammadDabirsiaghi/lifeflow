import type { AgColumn, ColumnEventType, ColumnMenuItemsSource } from 'ag-grid-community';
...
export declare class ToolPanelColumnComp extends Component {
    ...
    constructor(modelItem: ColumnModelItem, allowDragging: boolean, groupsExist: boolean, focusWrapper: HTMLElement, params: ToolPanelColumnCompParams, eventType: ColumnEventType, source: ColumnMenuItemsSource);
    postConstruct(): void;
    getColumn(): AgColumn;
