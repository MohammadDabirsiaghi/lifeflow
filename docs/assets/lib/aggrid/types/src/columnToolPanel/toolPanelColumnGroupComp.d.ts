...
export declare class ToolPanelColumnGroupComp extends Component {
    ...
    constructor(modelItem: ColumnModelItem, allowDragging: boolean, eventType: ColumnEventType, focusWrapper: HTMLElement, params: ColumnStateUpdateParams, source: ColumnMenuItemsSource);
    postConstruct(): void;
    getColumns(): AgColumn[];
