import type { AgColumn, FormulaFunctionParams, IFormulaService, NamedBean, RowNode, _ChangedRowNodes } from 'ag-grid-community';
...
export declare class FormulaService extends BeanStub implements IFormulaService, NamedBean, FormulaResolver {
    ...
    private calculatedColumnsActive;
    ...
    private checkForBaseIncompatibleServices;
    private checkForEditableFormulaIncompatibleServices;
    postConstruct(): void;
     ...
     */
    validateExpression(expression: string): FormulaError | null;
    /**
    ...
    private ensureEditableCellFormula;
    private ensureCalculatedCellFormula;
