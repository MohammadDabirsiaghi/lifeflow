...
export declare class TreeSetDisplayValueModel<V> implements ISetDisplayValueModel<V> {
    ...
    constructor(log: LogService, formatter: TextFormatter, treeListPathGetter?: ((value: V | null) => string[] | null) | undefined, treeListFormatter?: ((pathKey: string | null, level: number, parentPathKeys: (string | null)[]) => string) | undefined, treeDataOrGrouping?: boolean | undefined);
    updateParams(treeListPathGetter?: (value: V | null) => string[] | null, treeListFormatter?: (pathKey: string | null, level: number, parentPathKeys: (string | null)[]) => string): void;
