...
export declare class ToolPanelWrapper extends Component {
    ...
    private animationId;
    private defParent;
    private hasStyledRoot;
    constructor();
    postConstruct(): void;
    ensureStyledRoot(): void;
    getToolPanelId(): string;
    getDefParent(): HTMLElement | null;
    setDefParent(parent: HTMLElement | null): void;
    ...
    refresh(): void;
    animateDisplayed(displayed: boolean): void;
}
