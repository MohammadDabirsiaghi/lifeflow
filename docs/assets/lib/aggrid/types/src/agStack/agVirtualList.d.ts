import type { AgComponent, AgComponentEvent, AgCoreBeanCollection, BaseEvents, BaseProperties, IPropertiesService, StopPropagationCallbacks } from 'ag-stack';
...
export declare class AgVirtualList<TBeanCollection extends AgCoreBeanCollection<TProperties, TGlobalEvents, TCommon, TPropertiesService>, TProperties extends BaseProperties, TGlobalEvents extends BaseEvents, TCommon, TPropertiesService extends IPropertiesService<TProperties, TCommon>, TComponentSelectorType extends string, C extends AgComponent<TBeanCollection, TProperties, TGlobalEvents, any> = AgComponent<TBeanCollection, TProperties, TGlobalEvents, any>, V = any, TEventType extends string = AgComponentEvent> extends AgTabGuardComp<TBeanCollection, TProperties, TGlobalEvents, TCommon, TPropertiesService, TComponentSelectorType, TEventType> {
    ...
    constructor(stopPropagationCallbacks?: StopPropagationCallbacks | undefined, params?: VirtualListParams<C>);
    postConstruct(): void;
