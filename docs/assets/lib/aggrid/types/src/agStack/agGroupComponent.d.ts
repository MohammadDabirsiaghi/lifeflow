...
import type { _AgWidgetSelectorType } from 'ag-grid-community';
...
export declare class AgGroupComponent<TBeanCollection extends AgCoreBeanCollection<TProperties, TGlobalEvents, TCommon, TPropertiesService>, TProperties extends BaseProperties, TGlobalEvents extends BaseEvents, TCommon, TPropertiesService extends IPropertiesService<TProperties, TCommon>, TComponentSelectorType extends string> extends AgComponentStub<TBeanCollection, TProperties, TGlobalEvents, TCommon, TPropertiesService, TComponentSelectorType, AgGroupComponentEvent> {
    ...
    setDirection(direction: GroupDirection): this;
    private insertItem;
...
export declare const AgGroupComponentSelector: AgComponentSelector<_AgWidgetSelectorType>;
export {};
