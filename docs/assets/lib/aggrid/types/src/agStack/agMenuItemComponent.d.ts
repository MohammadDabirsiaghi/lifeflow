import type { AgComponent, AgCoreBeanCollection, BaseEvents, BaseProperties, IPropertiesService, StopPropagationCallbacks, WithoutCommon } from 'ag-stack';
import { AgBeanStub } from 'ag-stack';
import type { AgEvent, AgPromise, IComponent, IMenuItem } from 'ag-grid-community';
...
export interface AgMenuItemActivatedEvent<TBeanCollection extends AgCoreBeanCollection<TProperties, TGlobalEvents, TCommon, TPropertiesService>, TProperties extends BaseProperties, TGlobalEvents extends BaseEvents, TCommon, TPropertiesService extends IPropertiesService<TProperties, TCommon>, TComponentSelectorType extends string, TMenuActionParams extends TCommon> extends AgEvent<'menuItemActivated'> {
...
export declare class AgMenuItemComponent<TBeanCollection extends AgCoreBeanCollection<TProperties, TGlobalEvents, TCommon, TPropertiesService>, TProperties extends BaseProperties, TGlobalEvents extends BaseEvents, TCommon, TPropertiesService extends IPropertiesService<TProperties, TCommon>, TComponentSelectorType extends string, TMenuActionParams extends TCommon> extends AgBeanStub<TBeanCollection, TProperties, TGlobalEvents, TCommon, TPropertiesService, AgMenuItemComponentEvent> {
    ...
    isDisabled(): boolean;
    openSubMenu(activateFirstItem?: boolean, event?: MouseEvent | KeyboardEvent | Touch): void;
    ...
    deactivate(): void;
    getGui(): HTMLElement;
    getParentComponent(): AgComponent<TBeanCollection, TProperties, TGlobalEvents, any> | undefined;
